  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 relative">
      ...
      <button 
        ...
        className="absolute top-2 right-2 w-6 h-6 bg-gray-700 text-white rounded-full flex items-center justify-center hover:bg-gray-600"
        aria-label="Hide achievements board"
      >
        <X className="w-4 h-4" />
      </button>
      
      <h2 className="font-semibold text-lg mb-4 text-white">Achievements</h2>
